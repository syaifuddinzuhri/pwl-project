            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Data Penyewaan</h5>
                ...
                <div class="page-body">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <a href="{{route('customer.car.index')}}" class="btn btn-primary">Sewa Mobil Baru</a>
                        </div>
                        <div class="col-12">
                            <div class="card cars">
...
<div class="modal fade" id="buktiTransactionModal" tabindex="-1" aria-labelledby="buktiTransactionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="buktiTransactionModalLabel">Upload Bukti Pembayaran</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="body-bukti-modal">
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="detailTransactionModal" tabindex="-1" aria-labelledby="detailTransactionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailTransactionModalLabel">Detail Sewa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="body-detail-modal">
            </div>
        </div>
    </div>
</div>
...
<script src="{{ asset('js/user_transaction.js')}}" type="module"></script>
@endsection
