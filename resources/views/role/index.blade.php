            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Data Roles</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4   mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-material" id="form-add-role">
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="form-group form-primary ">
                                                    <input type="text" class="form-control" name="name" id="name" value="{{ old('name')}}">
                                                    <span class="form-bar"></span>
                                                    <label class="float-label" for="name">Nama Role</label>
                                                </div>
                                            </div>
                                            <div class="col-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteRoleModalLabel">Konfirmasi Hapus Data</h5>
            ...
            <div class="modal-footer">
                ...
                <form class="md-float-material form-material" id="form-delete-role" method="POST">
                    @csrf
                    @method('DELETE')
