            ...
            <ul class="nav-right">
                <li class="header-notification">
                    ...
                    <ul class="show-notification">
                        ...
                        <li class="waves-effect waves-light">
                            <div class="media">
                                <img class="d-flex align-self-center img-radius" src="{{ asset('admin-templates')}}/images/avatar-4.jpg" alt="Generic placeholder image">
                                <div class="media-body">
                        ...
                        <li class="waves-effect waves-light">
                            <div class="media">
                                <img class="d-flex align-self-center img-radius" src="{{ asset('admin-templates')}}/images/avatar-3.jpg" alt="Generic placeholder image">
                                <div class="media-body">
