            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Data Permissions</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4  mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="md-float-material form-material" id="form-add-permission">
                                        <div class="form-group row">
                                            <label class="col-12 col-form-label">Nama Permission</label>
                                            <div class="col-8">
                                                <input type="text" class="form-control" name="name" id="name" placeholder="Masukkan nama permission" value="{{ old('name')}}">
                                                @error('name')
                        ...
                        <div class="col-md-8">
                            <div class="card permissions">
                                ...
                                <div class="card-body">
                                    <table id="table-permissions" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nama</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editPermissionModalLabel">Edit Permission Baru</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="md-float-material form-material" id="form-edit-permission">
                <div class="modal-body">
                    <div class="text-primary" id="loading"><span>Loading...</span></div>
                    <div class="form-group row" id="body-edit-permission">
                        <label class="col-12 col-form-label">Nama Permission</label>
                        <div class="col-12">
                            <input type="text" class="form-control" id="name-edit" placeholder="Masukkan nama permission">
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="deletePermissionModal" tabindex="-1" aria-labelledby="deletePermissionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deletePermissionModalLabel">Konfirmasi Hapus Data</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary" data-dismiss="modal"><i class="fa fa-mail-reply"></i>Close</button>
                <form class="md-float-material form-material" id="form-delete-permission" method="POST">
                    @csrf
                    @method('DELETE')
...
<script src="{{ asset('js/permission.js')}}" type="module"></script>
@endsection
